      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link to="/imoveis" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">
              Ver Imóveis
            </Link>
            <Link to="/contato" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">
              Contato
            </Link>
            <Link 
              to="/admin/login" 

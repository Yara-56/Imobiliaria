...
import { 
  Box, Container, SimpleGrid, Stack, Text, Icon, Flex, Separator, Link as ChakraLink 
    ...
    <Box bg="white" color="gray.700" borderTop="1px solid" borderColor="gray.100" pt={16} pb={8}>
      <Container maxW="7xl">
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} gap={12} mb={12}>
          ...
          <Stack gap={4}>
            <Text fontWeight="bold" fontSize="sm" textTransform="uppercase" letterSpacing="widest">Produto</Text>
          ...
          <Stack gap={4}>
            <Text fontWeight="bold" fontSize="sm" textTransform="uppercase" letterSpacing="widest">Empresa</Text>
          ...
          <Stack gap={4}>
            <Text fontWeight="bold" fontSize="sm" textTransform="uppercase" letterSpacing="widest">Legal</Text>
...
const FooterLink = ({ to, children }: { to: string; children: React.ReactNode }) => (
  <ChakraLink fontSize="sm" color="gray.500" _hover={{ color: "blue.600", textDecoration: "none" }}>

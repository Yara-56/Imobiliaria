...
import {
  ...
  Button, Icon, Center, SimpleGrid, Separator,
...
// ═══════════════════════════════════════════════════════════════════════
// IMPORTS CORRIGIDOS - Ajuste os caminhos conforme sua estrutura
// ═══════════════════════════════════════════════════════════════════════

// Hooks
import { useDashboard } from "../hooks/useDashboard"; // ou o caminho correto
import { useTenants } from "../../tenants/hooks/useTenants"; // ou o caminho correto

import { QuickActionCard } from "./QuickActionCard";
import { PortfolioHealth } from "./PortfolioHealth";
import { RecentActivity } from "./RecentActivity";

// Componente de tenants
...
import { PortfolioHealth } from "@/features/dashboard/components/PortfolioHealth";
...
export default function DashboardPage() {
  ...
  const { actions: tenantActions } = useTenants();
      ...
      <MBox {...fadeUp(0)} mb={8}>
        <Flex justify="space-between" align="center" wrap="wrap" gap={4}>
          ...
          <HStack gap={3}>
            ...
            <QuickAddTenantModal 
              onCreate={tenantActions.quickAdd}
              onSuccess={() => {
                // Opcional: Redirecionar para lista de inquilinos
                // navigate("/tenants");
              }}
            />
        ...
        <MBox {...fadeUp(0.45)}>
          <Box bg="white" borderRadius="2xl" p={6} w="full"
            ...
            <VStack gap={1} align="stretch">
              {[
                { label: "Inquilinos",  icon: LuUsers,      path: "/tenants"    },
